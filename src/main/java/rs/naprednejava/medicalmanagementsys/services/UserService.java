...
public class UserService {
	...
	@Autowired
	private rs.naprednejava.medicalmanagementsys.repositories.UserRepository userRepository;
    	...
    	return userRepository.findByUsernameAndPasswordAndUserRole(user.getUsername(), user.getPassword(), user.getUserRole());
	 	...
	 	public ResponseEntity<User> getUsersById(Long id) {
	    	User user = userRepository.findById(id)
	 				.orElseThrow(() -> new exceptions.ResourceNotFoundException("User does not exist with id :" + id));
