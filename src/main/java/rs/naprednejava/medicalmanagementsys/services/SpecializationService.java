...
public class SpecializationService {
	@Autowired
    private rs.naprednejava.medicalmanagementsys.repositories.SpecializationRepository specializationRepository;
    ...
    public List<Specialization> getAllSpecializations(){
   	...
   	public ResponseEntity<Specialization> getSpecializationById(Long id) {
   		Specialization specialization = specializationRepository.findById(id)
   				.orElseThrow(() -> new exceptions.ResourceNotFoundException("Specialization does not exist with id :" + id));
